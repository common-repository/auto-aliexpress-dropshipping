...
<div class="aliexpress-box-settings-row">
    ...
    <div class="aliexpress-box-settings-col-1">
        <span class="aliexpress-settings-label"><?php esc_html_e( 'Language and Location', Auto_Aliexpress::DOMAIN ); ?></span>
        <span class="aliexpress-description"><?php esc_html_e( 'You can select get feed from specify language and location.', Auto_Aliexpress::DOMAIN ); ?></span>
    </div>
