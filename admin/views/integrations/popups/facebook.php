<?php
$current_addon_data = auto_aliexpress_get_addon_data('facebook');
?>
<div class="aliexpress-box" role="document">
    ...
    <div class="aliexpress-box-header aliexpress-block-content-center">
        ...
        <div class="aliexpress-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AUTO_ALIEXPRESS_URL.'/assets/images/facebook.png'); ?>" alt="<?php esc_attr_e( 'Facebook API', Auto_Aliexpress::DOMAIN ); ?>">

        </div>

        <div class="aliexpress-box-content integration-header">

            <h3 class="aliexpress-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Facebook API', Auto_Aliexpress::DOMAIN ); ?></h3>

			<span class="aliexpress-description">
                <?php esc_html_e( 'Setup Facebook API to be used by Auto Aliexpress to display tweets on your blog.', Auto_Aliexpress::DOMAIN ); ?>
			</span>
