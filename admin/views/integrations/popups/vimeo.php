<?php
$current_addon_data = auto_aliexpress_get_addon_data('vimeo');
?>
<div class="aliexpress-box" role="document">
    ...
    <div class="aliexpress-box-header aliexpress-block-content-center">
        ...
        <div class="aliexpress-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AUTO_ALIEXPRESS_URL.'/assets/images/vimeo.png'); ?>" alt="<?php esc_attr_e( 'Vimeo API', Auto_Aliexpress::DOMAIN ); ?>">

        </div>

        <div class="aliexpress-box-content integration-header">

            <h3 class="aliexpress-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Vimeo API', Auto_Aliexpress::DOMAIN ); ?></h3>

			<span class="aliexpress-description">
                <?php esc_html_e( 'Setup Vimeo API to be used by Auto Aliexpress to display tweets on your blog.', Auto_Aliexpress::DOMAIN ); ?>
			</span>
