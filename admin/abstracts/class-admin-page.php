<?php
/**
 * Auto_Aliexpress_Admin_Page Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Auto_Aliexpress_Admin_Page' ) ) :

    abstract class Auto_Aliexpress_Admin_Page {
        ...
        */
        ...
        ?>
            <main class="aliexpress-wrap">

                <?php
                    $this->render_menu();
                ?>

                <div class="aliexpress-content-wrap">
        ...
        protected function render_header() {
            ...
            <header class="aliexpress-header">
                <?php
                if ( $this->template_exists( $this->folder . '/header' ) ) {
                    $this->template( $this->folder . '/header' );
                } else {
                    ?>
                    <h1 class="aliexpress-header-title"><?php echo esc_html( get_admin_page_title() ); ?></h1>
                <?php } ?>
        ...
        protected function render_footer() {
            ...
            ?>
            <div class="aliexpress-footer"><?php echo esc_html__( 'Made by WPHobby', 'auto-aliexpress' ); ?></div>
            <?php
        }
        ...
        public function template( $path, $args = array(), $echo = true ) {
            $file    = AUTO_ALIEXPRESS_DIR . "/admin/views/$path.php";
            $content = '';
        ...
        public function enqueue_scripts( $hook ) {
            ...
            // Load admin fonts
            auto_aliexpress_admin_enqueue_fonts( AUTO_ALIEXPRESS_VERSION );
            ...
            // Load admin scripts
            auto_aliexpress_admin_enqueue_scripts(
        ...
        public function init_scripts( $hook ) {
            // Init jquery ui
            auto_aliexpress_admin_jquery_ui_init();
        }
