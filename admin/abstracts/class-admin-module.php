<?php
/**
 * Auto_Aliexpress_Admin_Module Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Auto_Aliexpress_Admin_Module' ) ) :

abstract class Auto_Aliexpress_Admin_Module {
	...
	/**
	 * Auto_Aliexpress_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
	public function __construct() {
		...
		add_filter( 'auto_aliexpress_data', array( $this, 'add_js_defaults' ) );
	...
	public function admin_submenu_file( $submenu_file, $parent_file ) {
		...
		if ( 'auto_aliexpress' !== $parent_file ) {
			return $submenu_file;
		}
