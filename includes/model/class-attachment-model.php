...
/**
 * Description of Auto_Aliexpress_Attachment
 *
 * @author Andrey
 */
if (!class_exists('Auto_Aliexpress_Attachment')) {

    class Auto_Aliexpress_Attachment {
        ...
        public function __construct($use_external = 'cfg') {
            if ('external' === $use_external || 'local' === $use_external) {
                ...
                $this->use_external_image_urls = true;
            }
        }
        ...
        public function create_attachment($post_id, $image_path, $params = array()) {
            ...
            $image_path = $this->clear_image_url($image_path);
        ...
        public function create_attachment_from_data($post_id, $file_data, $params = array()) {
            ...
            $ext = Auto_Aliexpress_Attachment::mime2ext($matches[1]);
            if (!$ext) {
        ...
        public function clear_image_url($img_url, $param_str = '') {
