...
if ( ! class_exists( 'Auto_Aliexpress_Custom_Form' ) ) :

class Auto_Aliexpress_Custom_Form extends Auto_Aliexpress_Module {
	...
	public function load_admin() {
		if( is_admin() ) {
			...
			new Auto_Aliexpress_Custom_Form_Admin();
		}
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'auto_aliexpress', $args );
	}
	...
	public function options() {
		return array(
			'name'          => esc_html__('Custom Forms', Auto_Aliexpress::DOMAIN),
			'singular_name' => esc_html__('Custom Form', Auto_Aliexpress::DOMAIN),
			'description'   => esc_html__( "Custom forms, conditional forms, etc. Choose from our library of forms or create a new one from scratch.", Auto_Aliexpress::DOMAIN ),
			'button_label'  => esc_html__( "New Custom Form", Auto_Aliexpress::DOMAIN ),
