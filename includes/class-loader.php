...
if ( ! class_exists( 'Auto_Aliexpress_Loader' ) ) :

class Auto_Aliexpress_Loader {
	...
	/**
	 * Auto_Aliexpress_Loader constructor.
	 *
	 */
	...
	public function load_files( $dir, $requirements = array() ) {
		$files = scandir( AUTO_ALIEXPRESS_DIR . $dir );
		foreach ( $files as $file ) {
			$path = AUTO_ALIEXPRESS_DIR . $dir . '/' . $file;
	...
	private function init( $name ) {
		$class = 'Auto_Aliexpress_' . $this->normalize( $name );
